...
size_t number_correct_digits_float(const char* result, const char* reference);
...
void float_precision() {
    ...
    printf(
        "Near zero, floats have about %lu digits of precision.\n",
        number_correct_digits_float(str_at_zero, ONE_NINTH)
    );
    free(str_at_zero);
    ...
    printf(
        "Near one million, floats have about %lu digits of precision.\n",
        number_correct_digits_float(str_at_million, TEN_MILLION_NINTHS)
    );
    free(str_at_million);
    ...
    printf(
        "Near one billion, floats have about %lu digits of precision.\n",
        number_correct_digits_float(str_at_billion, TEN_BILLION_NINTHS)
    );
    free(str_at_billion);
}
...
void double_precision() {
    ...
    printf(
        "Near zero, doubles have about %lu digits of precision.\n",
        number_correct_digits_float(str_at_zero, ONE_NINTH)
    );
    free(str_at_zero);
    ...
    printf(
        "Near one million, doubles have about %lu digits of precision.\n",
        number_correct_digits_float(str_at_million, TEN_MILLION_NINTHS)
    );
    free(str_at_million);
    ...
    printf(
        "Near one billion, doubles have about %lu digits of precision.\n",
        number_correct_digits_float(str_at_billion, TEN_BILLION_NINTHS)
    );
    free(str_at_billion);
}
...
size_t number_correct_digits_float(const char* result, const char* reference) {
    // Avoid out-of-bounds access. Assumes well-formed strings.
    size_t res_len = strlen(result);
    size_t ref_len = strlen(reference);
    size_t min_length = res_len < ref_len ? res_len : ref_len;
