...
int number_correct_digits(const char* result, const char* reference);

int main(int argc, char* argv[]) {
    // Note I'm using digits not decimal places, I assumed this was what was wanted.
    float_precision();
    double_precision();
...
void float_precision() {
    ...
    printf("Near zero, floats have about %d digits of precision.\n", number_correct_digits(str_at_zero, ONE_NINTH));
